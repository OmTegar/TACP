...
cd /var/www/html/ && clone_repo "https://github.com/OmTegar/test-bootstrap-studio.git"

# Give permission to access asset directory and index.php file
chmod 777 -R /var/www/html/test-bootstrap-studio/
...
<VirtualHost *:80>
        ...
        DocumentRoot /var/www/html/test-bootstrap-studio/
