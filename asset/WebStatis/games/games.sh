...
cd /var/www/html/ && clone_repo "https://github.com/OmTegar/mini-games-html-css-js-basic.git"

# Give permission to access asset directory and index.php file
chmod 777 -R /var/www/html/mini-games-html-css-js-basic/
...
<VirtualHost *:80>
        ...
        DocumentRoot /var/www/html/mini-games-html-css-js-basic/
